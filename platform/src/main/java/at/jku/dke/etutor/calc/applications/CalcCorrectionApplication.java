...
public class CalcCorrectionApplication {
    ...
    private static final String INSTRUCTION_WRITER = "src/main/resources/instructions/instructionWriterNew.docx";
    private static final String SOLUTION_CALC = "src/main/resources/instructions/solutionCalcNew.xlsx";
    private static final String SUBMISSION_CALC = "src/main/resources/instructions/instructionCalcNew.xlsx";
...
//    private static final String INSTRUCTION  = "src/main/resources/calc/randomInstruction.xlsx";
    ...
    public static void main(String[] args) throws Exception {
        ...
        FileInputStream submissionCalc = new FileInputStream(new File(SUBMISSION_CALC));
