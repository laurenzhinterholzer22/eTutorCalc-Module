...
//    }
    ...
    public ResponseEntity<String> correctCalcTaskDatabase (@PathVariable String courseInstanceUUID, @PathVariable String exerciseSheetUUID,
        ...
        StudentService.insertIntoExternalDatabase(matriculationNo, courseInstanceUUID, exerciseSheetUUID, taskNo, maxPoints, achievedPoints, "diagnose");
    ...
    public ResponseEntity<Void> handleDispatcherPointsCalcTask(@PathVariable String courseInstanceUUID, @PathVariable String exerciseSheetUUID,
        ...
        StudentService.insertIntoExternalDatabase(matriculationNo, courseInstanceUUID, exerciseSheetUUID, taskNo, maxPoints, achievedPoints, "submit");
        return ResponseEntity.ok().build();
    }
