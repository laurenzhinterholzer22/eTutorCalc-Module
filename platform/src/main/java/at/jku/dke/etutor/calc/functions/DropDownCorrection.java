...
//     */
//    public static String correctDropDown (XSSFWorkbook workbook_solution, XSSFWorkbook workbook_submission,  Sheet sheet_solution, Sheet sheet_submission) throws Exception {
//        try {
//
//            // List of cell with all dropdown cells (all cells with a green background color) of the solution
//            List<Cell> dropdown_cells_solution = FillColorHex.getDropdownCells(sheet_solution);
//
...
//            for (Cell current_dropdown_cell_solution : dropdown_cells_solution) {
//
...
//
//                if (isDropdown(sheet_solution, current_dropdown_cell_solution)) {
...
//                                        Cell currentCell_submission = sheet_submission.getRow(currentCell_solution.getRowIndex()).getCell(currentCell_solution.getColumnIndex());
//                                        if (currentCell_submission.getCellType() == CellType.FORMULA) {
//                                            ValuesCorrection.overrideUnknownFormulas(formulaEvaluator_submission, currentCell_submission);
//                                        }
//                                        if (FillColorHex.isDropdownCell(sheet_solution, currentCell_solution) && (!(currentCell_solution.getColumnIndex() == current_dropdown_cell_solution.getColumnIndex() && currentCell_solution.getRowIndex() == current_dropdown_cell_solution.getRowIndex()))) {
//                                            sheet_submission.getRow(currentCell_solution.getRowIndex()).getCell(currentCell_solution.getColumnIndex()).setCellValue(currentCell_solution.getStringCellValue());
//                                        }
//                                        if (currentCell_solution.getCellType() == CellType.FORMULA && currentCell_submission.getCellType() == CellType.FORMULA) {
//                                            ValuesCorrection.overrideUnknownFormulas(formulaEvaluator_solution, currentCell_solution);
//                                            ValuesCorrection.overrideUnknownFormulas(formulaEvaluator_submission, currentCell_submission);
//                                        }
//                                        if (FillColorHex.isValueCell(sheet_solution, currentCell_solution)) {
//                                            if (currentCell_solution.getCellType() == CellType.FORMULA) {
//                                                formulaEvaluator_solution.evaluateFormulaCell(currentCell_solution);
//                                            }
