...
public class CorrectionService {
    ...
    public static RandomInstruction createInstruction (XWPFDocument instructionWriter, XSSFWorkbook instructionCalc, XSSFWorkbook solutionCalc, String login) throws Exception {
